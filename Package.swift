...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YSIFLYADLib",
            url: "https://github.com/LJMcarryu/YSIFLYADLib_iOS/releases/download/6.0.10/YSIFLYADLib.xcframework.zip",
            checksum: "7abea367272c9ecf449e50f63cf4878902937af1838cd76e04d2aea9b66f8739"
        ),
    ]
)
