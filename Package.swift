...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/LJMcarryu/YSIFLYADLib_iOS/releases/download/6.3.1/YSIFLYADLib.xcframework.zip",
            checksum: "2c2d14bc635ae4fe9784934ea93b039c03c2d244449fff74f3857fff7b35bbdd"
        ),
        .target(
