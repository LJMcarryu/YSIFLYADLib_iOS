...
`6.3.1` 正式签名资产、checksum 和 A/B 已完成冻结。仓库根 `release-state.json` 由编排器
生成不可变候选时推进为 `6.3.1/FROZEN`。
当前最新公开正式版为
...
- `YSIFLYADLib-6.3.1.zip` 的 SHA-256：`0b5eed5b5e037c550b0e441b587c249279fc1c80cdd7ea5f863bf72e793553f0`
...
`6.3.1` 不沿用历史风险授权；主动扫描策略固定为 `failOn=high`、`failOnWarning=true`、
...
`6.2.3` 已于 2026-08-16 正式公开；annotated tag 解引用到
...
其二进制源码提交为 `ea0240e620b57d7275e486199099c648f51de257`，发布元数据提交为
...
`6.2.3` 冻结资产校验值：SwiftPM checksum 为 `84c77f4b9930f892086e08ec9f4185af474eab72a403905f4c5d9257936667a2`，`YSIFLYADLib-6.2.3.zip` 的 SHA-256 为 `904de36f02046e7612bec459bb432b203aa44cb21fd12ba5511f6c8b5bd1179e`。
...
`6.3.1` 还必须验证 NativeFeed 外部 CTA 默认关闭；显式开启时允许 permissive attach，container
